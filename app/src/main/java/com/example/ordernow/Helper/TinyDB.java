...
public class TinyDB {
    ...
    public ArrayList<FoodListDomain> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<FoodListDomain> playerList =  new ArrayList<FoodListDomain>();

        for(String jObjString : objStrings){
            FoodListDomain player  = gson.fromJson(jObjString,  FoodListDomain.class);
    ...
    public void putListObject(String key, ArrayList<FoodListDomain> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(FoodListDomain player: playerList){
